...
document.addEventListener("DOMContentLoaded", function () {
    const s = document.querySelector(".burger"),
        e = document.querySelector(".header__nav");
    s.addEventListener("click", () => {
        e.classList.toggle("active"), s.classList.toggle("active");
    }),
    ...
    for (let t = 1; t < arguments.length; t += 1) {
        ...
        if (i != null && !pt(i)) {
            ...
            for (let r = 0, c = a.length; r < c; r += 1) {
                const d = a[r],
                    u = Object.getOwnPropertyDescriptor(i, d);
                u !== void 0 &&
                    u.enumerable &&
                    (be(s[d]) && be(i[d])
                        ? i[d].__swiper__
                        ...
                        : !be(s[d]) && be(i[d])
                        ? ((s[d] = {}),
                          i[d].__swiper__ ? (s[d] = i[d]) : K(s[d], i[d]))
                        : (s[d] = i[d]));
            }
        }
    }
...
function rt(s) {
    ...
    const o = t > r ? "next" : "prev",
        f = (w, g) => (o === "next" && w >= g) || (o === "prev" && w <= g),
        m = () => {
            (d = new Date().getTime()), c === null && (c = d);
            const w = Math.max(Math.min((d - c) / u, 1), 0),
                g = 0.5 - Math.cos(w * Math.PI) / 2;
            let n = r + g * (t - r);
            if (
                (f(n, t) && (n = t), e.wrapperEl.scrollTo({ [i]: n }), f(n, t))
            ) {
...
function ce(s) {
    return (
        ...
        (s.shadowRoot &&
            s.shadowRoot.querySelector(".swiper-slide-transform")) ||
        s
    );
}
function _(s, e) {
...
function ht(s, e) {
    ...
    return (
        !i &&
            ...
            ((i = [...e.assignedElements()].includes(s)), i || (i = mt(s, e))),
        i
    );
}
function Ie(s) {
...
function ze(s) {
    ...
    return { top: i.top + d - r, left: i.left + u - c };
}
function gt(s, e) {
    const t = [];
...
function yt(s) {
    ...
    const m = r.match(/(iPod)(.*OS\s([\d_]+))?/),
        w = !f && r.match(/(iPhone\sOS|iOS)\s([\d_]+)/),
        g = a === "Win32";
    let n = a === "MacIntel";
    const l = [
        "1024x1366",
    ...
    return (
        !f &&
            ...
            f || (f = [0, 1, "13_0_0"]),
            (n = !1)),
        o && !g && ((c.os = "android"), (c.android = !0)),
        (f || w || m) && ((c.os = "ios"), (c.ios = !0)),
        c
    );
}
function nt(s) {
    return s === void 0 && (s = {}), Xe || (Xe = yt(s)), Xe;
}
let Ye;
function bt() {
    const s = V(),
...
function St(s) {
                ...
                ((r = new ResizeObserver((m) => {
                    c = a.requestAnimationFrame(() => {
                        ...
                        m.forEach((v) => {
                            ...
                            (p && p !== e.el) ||
                                ((n = h ? h.width : (y[0] || y).inlineSize),
                                (l = h ? h.height : (y[0] || y).blockSize));
                        }),
                            (n !== w || l !== g) && d();
                    });
                })),
    ...
    t("init", () => {
        ...
        a.addEventListener("resize", d),
            a.addEventListener("orientationchange", f);
    }),
        t("destroy", () => {
            o(),
                a.removeEventListener("resize", d),
                a.removeEventListener("orientationchange", f);
        });
}
function Et(s) {
    ...
    const r = [],
        ...
        d = function (f, m) {
            m === void 0 && (m = {});
            const w = c.MutationObserver || c.WebkitMutationObserver,
                g = new w((n) => {
            ...
            g.observe(f, {
                ...
                childList:
                    e.isElement ||
                    (typeof m.childList > "u" ? !0 : m).childList,
                characterData:
                    typeof m.characterData > "u" ? !0 : m.characterData,
            }),
                r.push(g);
        },
        u = () => {
            if (e.params.observer) {
                if (e.params.observeParents) {
                    const f = de(e.hostEl);
                    for (let m = 0; m < f.length; m += 1) d(f[m]);
                }
...
function Mt() {
    ...
    const t = s.params,
        ...
        o = u ? s.virtual.slides.length : s.slides.length,
        f = _(a, `.${s.params.slideClass}, swiper-slide`),
        m = u ? s.virtual.slides.length : f.length;
    let w = [];
    const g = [],
        n = [];
    ...
    typeof p == "string" && p.indexOf("%") >= 0
        ...
        t.centeredSlides &&
            t.cssMode &&
            (Se(i, "--swiper-centered-offset-before", ""),
            Se(i, "--swiper-centered-offset-after", ""));
    const z = t.grid && t.grid.rows > 1 && s.grid;
    z ? s.grid.initSlides(f) : s.grid && s.grid.unsetSlides();
    let A;
    const M =
    ...
    for (let T = 0; T < m; T += 1) {
        ...
        if (
            (f[T] && (L = f[T]),
            z && s.grid.updateSlide(T, L, f),
            !(f[T] && oe(L, "display") === "none"))
        ) {
            if (t.slidesPerView === "auto") {
                ...
                if (
                    ...
                    A = s.isHorizontal() ? _e(L, "width") : _e(L, "height");
                else {
                    const D = e(P, "width"),
                        G = e(P, "padding-left"),
                        S = e(P, "padding-right"),
                        x = e(P, "margin-left"),
                        B = e(P, "margin-right"),
                        X = P.getPropertyValue("box-sizing");
                    if (X && X === "border-box") A = D + x + B;
                    else {
                        const { clientWidth: N, offsetWidth: F } = L;
                        A = D + G + S + x + B + (F - N);
                    }
                }
                ...
                (A = (r - (t.slidesPerView - 1) * p) / t.slidesPerView),
                    t.roundLengths && (A = Math.floor(A)),
                    f[T] &&
                        (f[T].style[s.getDirectionLabel("width")] = `${A}px`);
            f[T] && (f[T].swiperSlideSize = A),
                n.push(A),
                t.centeredSlides
                    ? ((b = b + A / 2 + E / 2 + p),
                      E === 0 && T !== 0 && (b = b - r / 2 - p),
                      ...
                      O % t.slidesPerGroup === 0 && w.push(b),
                      g.push(b))
                    : (t.roundLengths && (b = Math.floor(b)),
                      (O - Math.min(s.params.slidesPerGroupSkip, O)) %
    ...
    if (
        ((s.virtualSize = Math.max(s.virtualSize, r) + v),
        c &&
            d &&
        ...
        z && s.grid.updateWrapperSize(A, w),
        !t.centeredSlides)
    ) {
        const T = [];
        for (let L = 0; L < w.length; L += 1) {
            ...
            t.roundLengths && (P = Math.floor(P)),
                w[L] <= s.virtualSize - r && T.push(P);
        }
        (w = T),
            Math.floor(s.virtualSize - r) - Math.floor(w[w.length - 1]) > 1 &&
                w.push(s.virtualSize - r);
    }
    if (u && t.loop) {
        const T = n[0] + p;
        if (t.slidesPerGroup > 1) {
            ...
            for (let C = 0; C < L; C += 1) w.push(w[w.length - 1] + P);
        }
        for (
            let L = 0;
            ...
            t.slidesPerGroup === 1 && w.push(w[w.length - 1] + T),
    ...
    if ((w.length === 0 && (w = [0]), p !== 0)) {
        ...
        f.filter((L, P) =>
            !t.cssMode || t.loop ? !0 : P !== f.length - 1
        ).forEach((L) => {
            L.style[T] = `${p}px`;
        });
    }
    ...
    if (
        ...
        Se(i, "--swiper-centered-offset-before", `${-w[0]}px`),
            Se(
                i,
                "--swiper-centered-offset-after",
                `${s.size / 2 - n[n.length - 1] / 2}px`
            );
        const T = -s.snapGrid[0],
            L = -s.slidesGrid[0];
        (s.snapGrid = s.snapGrid.map((P) => P + T)),
            (s.slidesGrid = s.slidesGrid.map((P) => P + L));
    }
    if (
        (m !== o && s.emit("slidesLengthChange"),
        w.length !== y &&
            (s.params.watchOverflow && s.checkOverflow(),
            s.emit("snapGridLengthChange")),
        g.length !== h && s.emit("slidesGridLengthChange"),
...
function Lt(s) {
    ...
    for (let u = 0; u < i.length; u += 1) {
        ...
        const m =
                (c + (t.centeredSlides ? e.minTranslate() : 0) - f) /
                (o.swiperSlideSize + d),
            w =
                (c - r[0] + (t.centeredSlides ? e.minTranslate() : 0) - f) /
                (o.swiperSlideSize + d),
            g = -(c - f),
            n = g + e.slidesSizesGrid[u],
            l = g >= 0 && g <= e.size - e.slidesSizesGrid[u],
            v =
                (g >= 0 && g < e.size - 1) ||
                (n > 1 && n <= e.size) ||
                (g <= 0 && n >= e.size);
        v && (e.visibleSlides.push(o), e.visibleSlidesIndexes.push(u)),
            Qe(o, v, t.slideVisibleClass),
            Qe(o, l, t.slideFullyVisibleClass),
            (o.progress = a ? -m : m),
            (o.originalProgress = a ? -w : w);
    }
}
function It(s) {
    const e = this;
    ...
    let { progress: a, isBeginning: r, isEnd: c, progressLoop: d } = e;
    const u = r,
        o = c;
    if (i === 0) (a = 0), (r = !0), (c = !0);
    else {
    ...
    Object.assign(e, {
        ...
        r && !u && e.emit("reachBeginning toEdge"),
        c && !o && e.emit("reachEnd toEdge"),
        ((u && !r) || (o && !c)) && e.emit("fromEdge"),
        e.emit("progress", a);
}
const Re = (s, e, t) => {
    e && !s.classList.contains(t)
...
function zt() {
    const s = this,
        ...
        d = (m) => _(i, `.${t.slideClass}${m}, swiper-slide${m}`)[0];
    let u, o, f;
    if (r)
        if (t.loop) {
            ...
            m < 0 && (m = s.virtual.slides.length + m),
                ...
                (u = d(`[data-swiper-slide-index="${m}"]`));
        } else u = d(`[data-swiper-slide-index="${a}"]`);
    else
        c
            ? ((u = e.find((m) => m.column === a)),
              (f = e.find((m) => m.column === a + 1)),
              (o = e.find((m) => m.column === a - 1)))
            : (u = e[a]);
    u &&
        (c ||
            ((f = vt(u, `.${t.slideClass}, swiper-slide`)[0]),
            t.loop && !f && (f = e[0]),
            (o = gt(u, `.${t.slideClass}, swiper-slide`)[0]),
            t.loop && !o === 0 && (o = e[e.length - 1]))),
        e.forEach((m) => {
            Re(m, m === u, t.slideActiveClass),
                Re(m, m === f, t.slideNextClass),
                Re(m, m === o, t.slidePrevClass);
        }),
        s.emitSlidesClasses();
}
const Le = (s, e) => {
    ...
    qe = (s) => {
        ...
        if (s.params.grid && s.params.grid.rows > 1) {
            const c = a,
                d = [c - e];
            d.push(...Array.from({ length: e }).map((u, o) => c + i + o)),
                s.slides.forEach((u, o) => {
                    d.includes(u.column) && Ve(s, o);
                });
            return;
        }
        const r = a + i - 1;
...
function Ot(s) {
    ...
    if ((typeof u > "u" && (u = At(e)), i.indexOf(t) >= 0)) o = i.indexOf(t);
    else {
    ...
    let w;
    if (e.virtual && a.virtual.enabled && a.loop) w = f(u);
    else if (m) {
        const g = e.slides.find((l) => l.column === u);
        let n = parseInt(g.getAttribute("data-swiper-slide-index"), 10);
        Number.isNaN(n) && (n = Math.max(e.slides.indexOf(g), 0)),
            (w = Math.floor(n / a.grid.rows));
    } else if (e.slides[u]) {
...
function $t(s, e) {
    ...
    !a &&
        ...
        [...e.slice(e.indexOf(s) + 1, e.length)].forEach((d) => {
            !a &&
                d.matches &&
                d.matches(`.${i.slideClass}, swiper-slide`) &&
                (a = d);
        });
    let r = !1,
        c;
    ...
    t.isHorizontal() ? (d = i ? -s : s) : (u = s),
        ...
        a.cssMode
            ...
            : a.virtualTranslate ||
              ...
              (r.style.transform = `translate3d(${d}px, ${u}px, ${o}px)`));
    let f;
    const m = t.maxTranslate() - t.minTranslate();
    m === 0 ? (f = 0) : (f = (s - t.minTranslate()) / m),
        f !== c && t.updateProgress(s),
...
function Xt(s, e, t, i, a) {
    s === void 0 && (s = 0),
        ...
        i === void 0 && (i = !0);
    const r = this,
        { params: c, wrapperEl: d } = r;
    if (r.animating && c.preventInteractionOnTransition) return !1;
    const u = r.minTranslate(),
        o = r.maxTranslate();
    let f;
    if (
        (i && s > u ? (f = u) : i && s < o ? (f = o) : (f = s),
        r.updateProgress(f),
        c.cssMode)
    ) {
        const m = r.isHorizontal();
        if (e === 0) d[m ? "scrollLeft" : "scrollTop"] = -f;
        else {
            ...
            d.scrollTo({ [m ? "left" : "top"]: -f, behavior: "smooth" });
        }
        return !0;
    }
    return (
        e === 0
            ? (r.setTransition(0),
              r.setTranslate(f),
              t &&
                  (r.emit("beforeTransitionStart", e, a),
            ...
            : (r.setTransition(e),
              ...
              r.animating ||
                  ...
                  r.onTranslateToWrapperTransitionEnd ||
                      (r.onTranslateToWrapperTransitionEnd = function (w) {
                          !r ||
                              r.destroyed ||
                              (w.target === this &&
...
function ot(s) {
    ...
    let d = i;
    d || (r > c ? (d = "next") : r < c ? (d = "prev") : (d = "reset")),
        e.emit(`transition${a}`),
        t && d === "reset"
...
var Ft = { setTransition: Rt, transitionStart: Vt, transitionEnd: Nt };
function Wt(s, e, t, i, a) {
    ...
    if (
        (!n && !i && !a) ||
        r.destroyed ||
        (r.animating && d.preventInteractionOnTransition)
    )
        return !1;
    ...
    if (d.normalizeSlideIndex)
        for (let z = 0; z < o.length; z += 1) {
            const A = -Math.floor(y * 100),
                M = Math.floor(o[z] * 100),
                T = Math.floor(o[z + 1] * 100);
            typeof o[z + 1] < "u"
                ? A >= M && A < T - (T - M) / 2
                    ? (c = z)
                    : A >= M && A < T && (c = z + 1)
    ...
    if (
        ...
        return !1;
    c !== (f || 0) && t && r.emit("beforeSlideChangeStart"),
        r.updateProgress(y);
    let h;
    ...
    if (!(p && a) && ((w && -y === r.translate) || (!w && y === r.translate)))
        return (
            ...
            d.effect !== "slide" && r.setTranslate(y),
    ...
    if (d.cssMode) {
        ...
        if (e === 0)
            ...
            g.scrollTo({ [z ? "left" : "top"]: A, behavior: "smooth" });
        }
        return !0;
    }
    const O = lt().isSafari;
    return (
        p && !a && O && r.isElement && r.virtual.update(!1, !1, c),
        r.setTransition(e),
        r.setTranslate(y),
        r.updateActiveIndex(c),
        r.updateSlidesClasses(),
    ...
    if (a.params.loop)
        if (a.virtual && a.params.virtual.enabled)
            ...
            if (r) {
                ...
                d = a.slides.find(
                    (g) => g.getAttribute("data-swiper-slide-index") * 1 === w
                ).column;
            } else d = a.getSlideIndexByData(c);
            const u = r
                    ? Math.ceil(a.slides.length / a.params.grid.rows)
                    : a.slides.length,
                { centeredSlides: o } = a.params;
            let f = a.params.slidesPerView;
            f === "auto"
                ? (f = a.slidesPerViewDynamic())
                : ((f = Math.ceil(parseFloat(a.params.slidesPerView, 10))),
                  o && f % 2 === 0 && (f = f + 1));
            let m = u - d < f;
            if (
                (o && (m = m || d < Math.ceil(f / 2)),
                i && o && a.params.slidesPerView !== "auto" && !r && (m = !1),
                m)
            ) {
                const w = o
                    ? d < a.activeIndex
                        ? "prev"
                        : "next"
                    : d - a.activeIndex - 1 < a.params.slidesPerView
                    ? "next"
                    : "prev";
                a.loopFix({
                    direction: w,
...
function qt(s, e, t) {
    ...
    const u = i.activeIndex < r.slidesPerGroupSkip ? 1 : d,
...
function jt(s, e, t) {
    ...
    const g = w(m),
        n = r.map((h) => w(h)),
        l = a.freeMode && a.freeMode.enabled;
...
function Kt(s, e, t, i) {
    ...
    const c = Math.min(a.params.slidesPerGroupSkip, r),
        d = c + Math.floor((r - c) / a.params.slidesPerGroup),
        u = a.rtlTranslate ? a.translate : -a.translate;
    if (u >= a.snapGrid[d]) {
        const o = a.snapGrid[d],
            f = a.snapGrid[d + 1];
        u - o > (f - o) * i && (r += a.params.slidesPerGroup);
    } else {
        const o = a.snapGrid[d - 1],
            f = a.snapGrid[d];
        u - o <= (f - o) * i && (r -= a.params.slidesPerGroup);
    }
    return (
    ...
    const { params: e, slidesEl: t } = s,
        i =
            e.slidesPerView === "auto"
                ? s.slidesPerViewDynamic()
                : e.slidesPerView;
    let a = s.getSlideIndexWhenGrid(s.clickedIndex),
        r;
    const c = s.isElement ? "swiper-slide" : `.${e.slideClass}`,
        d = s.grid && s.params.grid && s.params.grid.rows > 1;
    if (e.loop) {
        ...
        (r = parseInt(
            ...
            e.centeredSlides
                ...
                : a >
                  (d
                      ? (s.slides.length - i) / 2 - (s.params.grid.rows - 1)
                      : s.slides.length - i)
                ? (s.loopFix(),
                  (a = s.getSlideIndex(
                      _(t, `${c}[data-swiper-slide-index="${r}"]`)[0]
                  )),
                  me(() => {
                      s.slideTo(a);
                  }))
...
function Jt(s, e) {
    ...
    const r = () => {
            _(a, `.${i.slideClass}, swiper-slide`).forEach((g, n) => {
                g.setAttribute("data-swiper-slide-index", n);
            });
        },
        c = () => {
            const w = _(a, `.${i.slideBlankClass}`);
            w.forEach((g) => {
                g.remove();
            }),
                w.length > 0 && (t.recalcSlides(), t.updateSlides());
        },
        d = t.grid && i.grid && i.grid.rows > 1;
    i.loopAddBlankSlides && (i.slidesPerGroup > 1 || d) && c();
    const u = i.slidesPerGroup * (d ? i.grid.rows : 1),
        o = t.slides.length % u !== 0,
        f = d && t.slides.length % i.grid.rows !== 0,
        m = (w) => {
            for (let g = 0; g < w; g += 1) {
                const n = t.isElement
    ...
    if (o) {
        if (i.loopAddBlankSlides) {
            const w = u - (t.slides.length % u);
            m(w), t.recalcSlides(), t.updateSlides();
        } else
            Ie(
...
function es(s) {
    ...
    const {
        ...
        { centeredSlides: l, initialSlide: v } = n;
    if (
        ((o.allowSlidePrev = !0),
        (o.allowSlideNext = !0),
        o.virtual && n.virtual.enabled)
    ) {
        t &&
            (!n.centeredSlides && o.snapIndex === 0
                ? o.slideTo(o.virtual.slides.length, 0, !1, !0)
                : n.centeredSlides && o.snapIndex < n.slidesPerView
    ...
    y === "auto"
        ...
        : ((y = Math.ceil(parseFloat(n.slidesPerView, 10))),
          l && y % 2 === 0 && (y = y + 1));
    const h = n.slidesPerGroupAuto ? y : n.slidesPerGroup;
    let p = l ? Math.max(h, Math.ceil(y / 2)) : h;
    p % h !== 0 && (p += h - (p % h)),
        (p += n.loopAdditionalSlides),
        (o.loopedSlides = p);
    const b = o.grid && n.grid && n.grid.rows > 1;
    f.length < y + p || (o.params.effect === "cards" && f.length < y + p * 2)
        ? Ie(
    ...
    const E = [],
        O = [],
        z = b ? Math.ceil(f.length / n.grid.rows) : f.length,
        A = c && z - v < y && !l;
    let M = A ? v : o.activeIndex;
    typeof r > "u"
        ? (r = o.getSlideIndex(
              f.find((G) => G.classList.contains(n.slideActiveClass))
          ))
        : (M = r);
    const T = i === "next" || !i,
        L = i === "prev" || !i;
    ...
    if (D < p) {
        P = Math.max(p - D, h);
        for (let G = 0; G < p - D; G += 1) {
            const S = G - Math.floor(G / z) * z;
            if (b) {
                const x = z - S - 1;
                for (let B = f.length - 1; B >= 0; B -= 1)
                    f[B].column === x && E.push(B);
            } else E.push(z - S - 1);
        }
    } else if (D + y > z - p) {
        (C = Math.max(D - (z - p * 2), h)),
            A && (C = Math.max(C, y - z + v + 1));
        for (let G = 0; G < C; G += 1) {
            const S = G - Math.floor(G / z) * z;
            b
                ? f.forEach((x, B) => {
    ...
    if (
        ...
        L &&
            E.forEach((G) => {
                (f[G].swiperLoopMoveDOM = !0),
                    g.prepend(f[G]),
                    (f[G].swiperLoopMoveDOM = !1);
            }),
        T &&
            O.forEach((G) => {
                (f[G].swiperLoopMoveDOM = !0),
        ...
        n.slidesPerView === "auto"
            ? o.updateSlides()
            : b &&
              ((E.length > 0 && L) || (O.length > 0 && T)) &&
              o.slides.forEach((G, S) => {
                  o.grid.updateSlide(S, G, o.slides);
              }),
        n.watchSlidesProgress && o.updateSlidesOffset(),
        t)
    ) {
        if (E.length > 0 && L) {
            if (typeof e > "u") {
                const G = o.slidesGrid[M],
                    x = o.slidesGrid[M + P] - G;
                u
                    ? o.setTranslate(o.translate - x)
                    : (o.slideTo(M + Math.ceil(P), 0, !1, !0),
                      a &&
                          ((o.touchEventsData.startTranslate =
                              o.touchEventsData.startTranslate - x),
                          (o.touchEventsData.currentTranslate =
                              o.touchEventsData.currentTranslate - x)));
            } else if (a) {
                const G = b ? E.length / n.grid.rows : E.length;
                o.slideTo(o.activeIndex + G, 0, !1, !0),
                    (o.touchEventsData.currentTranslate = o.translate);
            }
        } else if (O.length > 0 && T)
            if (typeof e > "u") {
                const G = o.slidesGrid[M],
                    x = o.slidesGrid[M - C] - G;
                u
                    ? o.setTranslate(o.translate - x)
                    : (o.slideTo(M - C, 0, !1, !0),
                      a &&
                ...
                const G = b ? O.length / n.grid.rows : O.length;
                o.slideTo(o.activeIndex - G, 0, !1, !0);
            }
    }
    if (
        ((o.allowSlidePrev = m),
        (o.allowSlideNext = w),
        o.controller && o.controller.control && !d)
    ) {
        const G = {
            slideRealIndex: e,
            direction: i,
        ...
        Array.isArray(o.controller.control)
            ? o.controller.control.forEach((S) => {
                  !S.destroyed &&
                      S.params.loop &&
                      S.loopFix({
                          ...G,
                          slideTo:
                              S.params.slidesPerView === n.slidesPerView
                                  ? t
                                  : !1,
                      });
              })
...
var ss = { loopCreate: Jt, loopFix: es, loopDestroy: ts };
function is(s) {
    const e = this;
    if (
...
var as = { setGrabCursor: is, unsetGrabCursor: rs };
function ns(s, e) {
    e === void 0 && (e = this);
    function t(i) {
        if (!i || i === W() || i === V()) return null;
...
function ls(s) {
    ...
    if (i.type === "touchstart") {
        Je(e, i, i.targetTouches[0].pageX);
        return;
    }
    const { params: r, touches: c, enabled: d } = e;
    if (
        !d ||
    ...
    let u = i.target;
    if (
        (r.touchEventsTarget === "wrapper" && !ht(u, e.wrapperEl)) ||
        ("which" in i && i.which === 3) ||
        ("button" in i && i.button > 0) ||
        (a.isTouched && a.isMoved)
    )
        return;
    const o = !!r.noSwipingClass && r.noSwipingClass !== "",
        f = i.composedPath ? i.composedPath() : i.path;
    o && i.target && i.target.shadowRoot && f && (u = f[0]);
    const m = r.noSwipingSelector
            ? r.noSwipingSelector
            : `.${r.noSwipingClass}`,
        w = !!(i.target && i.target.shadowRoot);
    if (r.noSwiping && (w ? ns(m, u) : u.closest(m))) {
        e.allowClick = !0;
        return;
    }
    ...
    u.matches(a.focusableElements) &&
        ((l = !1), u.nodeName === "SELECT" && (a.isTouched = !1)),
        t.activeElement &&
...
function os(s) {
    const e = W(),
        t = this,
        i = t.touchEventsData,
        { params: a, touches: r, rtlTranslate: c, enabled: d } = t;
    ...
    if (a.touchReleaseOnEdges && !a.loop)
        if (t.isVertical()) {
            if (
                (m < r.startY && t.translate <= t.maxTranslate()) ||
                (m > r.startY && t.translate >= t.minTranslate())
            ) {
    ...
    i.allowTouchCallbacks && t.emit("touchMove", u),
        ...
        (r.currentX = f),
        (r.currentY = m);
    const w = r.currentX - r.startX,
        g = r.currentY - r.startY;
    if (t.params.threshold && Math.sqrt(w ** 2 + g ** 2) < t.params.threshold)
        return;
    if (typeof i.isScrolling > "u") {
        ...
        (t.isVertical() && r.currentX === r.startX)
            ? (i.isScrolling = !1)
            : w * w + g * g >= 25 &&
              ((E = (Math.atan2(Math.abs(g), Math.abs(w)) * 180) / Math.PI),
    ...
    t.emit("sliderMove", u),
        (i.isMoved = !0),
        (i.currentTranslate = n + i.startTranslate);
    let p = !0,
        b = a.resistanceRatio;
    if (
              ...
              i.currentTranslate > t.minTranslate() &&
                  ...
                  a.resistance &&
                      (i.currentTranslate =
                          t.minTranslate() -
                          1 +
                          (-t.minTranslate() + i.startTranslate + n) ** b)))
            : n < 0 &&
              (y &&
                  h &&
                  i.allowThresholdMove &&
              ...
              i.currentTranslate < t.maxTranslate() &&
                  ...
                  a.resistance &&
                      (i.currentTranslate =
                          t.maxTranslate() +
                          1 -
                          (t.maxTranslate() - i.startTranslate - n) ** b))),
        p && (u.preventedByNestedSwiper = !0),
        !t.allowSlideNext &&
...
function ds(s) {
    ...
    if (
        (c.followFinger
            ? (g = u ? e.translate : -e.translate)
            : (g = -t.currentTranslate),
        c.cssMode)
    )
        return;
    ...
    for (
        ...
        const O = E < c.slidesPerGroupSkip - 1 ? 1 : c.slidesPerGroup;
        typeof o[E + O] < "u"
            ? (n || (g >= o[E] && g < o[E + O])) &&
              ((l = E), (v = o[E + O] - o[E]))
            : (n || g >= o[E]) &&
              ((l = E), (v = o[o.length - 1] - o[o.length - 2]));
    }
    let y = null,
        h = null;
    c.rewind &&
        (e.isBeginning
            ...
            : e.isEnd && (y = 0));
    const p = (g - o[l]) / v,
        b = l < c.slidesPerGroupSkip - 1 ? 1 : c.slidesPerGroup;
    if (w > c.longSwipesMs) {
        if (!c.longSwipes) {
        ...
        e.swipeDirection === "next" &&
            (p >= c.longSwipesRatio
                ? e.slideTo(c.rewind && e.isEnd ? y : l + b)
                : e.slideTo(l)),
            e.swipeDirection === "prev" &&
                (p > 1 - c.longSwipesRatio
                    ? e.slideTo(l + b)
                    : h !== null && p < 0 && Math.abs(p) > c.longSwipesRatio
                    ? e.slideTo(h)
                    : e.slideTo(l));
    } else {
        if (!c.shortSwipes) {
        ...
        (i.target === e.navigation.nextEl || i.target === e.navigation.prevEl)
            ? i.target === e.navigation.nextEl
                ? e.slideTo(l + b)
                : e.slideTo(l)
            : (e.swipeDirection === "next" && e.slideTo(y !== null ? y : l + b),
              e.swipeDirection === "prev" && e.slideTo(h !== null ? h : l));
    }
}
function et() {
    const s = this,
...
const dt = (s, e) => {
    ...
    !a ||
        typeof a == "string" ||
        (t[u]("touchstart", s.onDocumentTouchStart, {
            passive: !1,
            capture: d,
        }),
        a[u]("touchstart", s.onTouchStart, { passive: !1 }),
        a[u]("pointerdown", s.onTouchStart, { passive: !1 }),
        t[u]("touchmove", s.onTouchMove, { passive: !1, capture: d }),
        t[u]("pointermove", s.onTouchMove, { passive: !1, capture: d }),
        ...
        (i.preventClicks || i.preventClicksPropagation) &&
            a[u]("click", s.onClick, !0),
        i.cssMode && r[u]("scroll", s.onScroll),
        i.updateOnWindowResize
            ...
            : s[o]("observerUpdate", et, !0),
        a[u]("load", s.onLoad, { capture: !0 }));
};
function ms() {
    const s = this,
        { params: e } = s;
    (s.onTouchStart = ls.bind(s)),
        (s.onTouchMove = os.bind(s)),
        (s.onTouchEnd = ds.bind(s)),
        (s.onDocumentTouchStart = ps.bind(s)),
        e.cssMode && (s.onScroll = fs.bind(s)),
        (s.onClick = cs.bind(s)),
        (s.onLoad = us.bind(s)),
        dt(s, "on");
}
...
var gs = { attachEvents: ms, detachEvents: hs };
const tt = (s, e) => s.grid && e.grid && e.grid.rows > 1;
function vs() {
    const s = this,
    ...
    const c = W(),
        ...
        o = s.getBreakpoint(r, d, u);
    if (!o || s.currentBreakpoint === o) return;
    const m = (o in r ? r[o] : void 0) || s.originalParams,
        w = tt(s, i),
        g = tt(s, m),
        n = s.params.grabCursor,
        l = m.grabCursor,
        v = i.enabled;
    w && !g
        ? (a.classList.remove(
        ...
        : !w &&
          ...
          s.emitContainerClasses()),
        n && !l ? s.unsetGrabCursor() : !n && l && s.setGrabCursor(),
        ["navigation", "pagination", "scrollbar"].forEach((O) => {
            if (typeof m[O] > "u") return;
            const z = i[O] && i[O].enabled,
                A = m[O] && m[O].enabled;
            z && !A && s[O].disable(), !z && A && s[O].enable();
        });
    const y = m.direction && m.direction !== i.direction,
        h = i.loop && (m.slidesPerView !== i.slidesPerView || y),
        p = i.loop;
    y && t && s.changeDirection(), K(s.params, m);
...
function ws(s, e, t) {
    ...
    const a = V(),
        ...
        c = Object.keys(s).map((d) => {
            if (typeof d == "string" && d.indexOf("@") === 0) {
                const u = parseFloat(d.substr(1));
                return { value: r * u, point: d };
            }
            return { value: d, point: d };
        });
    c.sort((d, u) => parseInt(d.value, 10) - parseInt(u.value, 10));
    for (let d = 0; d < c.length; d += 1) {
        const { point: u, value: o } = c[d];
        e === "window"
            ? a.matchMedia(`(min-width: ${o}px)`).matches && (i = u)
            : o <= t.clientWidth && (i = u);
    }
    return i || "max";
}
var ys = { setBreakpoint: vs, getBreakpoint: ws };
function bs(s, e) {
    const t = [];
    return (
        s.forEach((i) => {
...
var xs = { addClasses: Ss, removeClasses: Es };
function Ts() {
    const s = this,
...
class U {
    constructor() {
        ...
        if (
            ...
            const f = [];
            return (
                c.querySelectorAll(t.el).forEach((m) => {
                    const w = K({}, t, { el: m });
                    f.push(new U(w));
                }),
                f
        ...
        (d.__swiper__ = !0),
            (d.support = at()),
            (d.device = nt({ userAgent: t.userAgent })),
            (d.browser = lt()),
            (d.eventsListeners = {}),
        ...
        return (
            (d.params = K({}, o, Fe, t)),
            (d.originalParams = K({}, d.params)),
            (d.passedParams = K({}, t)),
            d.params &&
                d.params.on &&
                Object.keys(d.params.on).forEach((f) => {
    ...
    getSlideIndex(e) {
        const { slidesEl: t, params: i } = this,
            a = _(t, `.${i.slideClass}, swiper-slide`),
            r = xe(a[0]);
        return xe(e) - r;
    }
    ...
    slidesPerViewDynamic(e, t) {
        ...
        if (a.centeredSlides) {
            let m = r[o] ? Math.ceil(r[o].swiperSlideSize) : 0,
                w;
            for (let g = o + 1; g < r.length; g += 1)
                r[g] &&
                    !w &&
                    ((m += Math.ceil(r[g].swiperSlideSize)),
                    (f += 1),
                    m > u && (w = !0));
            for (let g = o - 1; g >= 0; g -= 1)
                r[g] &&
                    !w &&
                    ((m += r[g].swiperSlideSize), (f += 1), m > u && (w = !0));
        } else if (e === "current")
            for (let m = o + 1; m < r.length; m += 1)
                (t ? c[m] + d[m] - c[o] < u : c[m] - c[o] < u) && (f += 1);
        else for (let m = o - 1; m >= 0; m -= 1) c[o] - c[m] < u && (f += 1);
        return f;
    }
    update() {
        const e = this;
    ...
    mount(e) {
        ...
        return (
            !c &&
                ...
                ((c = Z("div", t.params.wrapperClass)),
                i.append(c),
                _(i, `.${t.params.slideClass}`).forEach((d) => {
                    c.append(d);
                })),
            Object.assign(t, {
                el: i,
                ...
                rtlTranslate:
                    ...
                    (i.dir.toLowerCase() === "rtl" ||
                        oe(i, "direction") === "rtl"),
                wrongRTL: oe(c, "display") === "-webkit-box",
            }),
            !0
        );
    }
    ...
    destroy(e, t) {
        ...
        const i = this,
            { params: a, el: r, wrapperEl: c, slides: d } = i;
        return (
            typeof i.params > "u" ||
                i.destroyed ||
    ...
    static use(e) {
        return Array.isArray(e)
            ? (e.forEach((t) => U.installModule(t)), U)
            : (U.installModule(e), U);
    }
}
Object.keys(Ne).forEach((s) => {
    Object.keys(Ne[s]).forEach((e) => {
        U.prototype[e] = Ne[s][e];
    });
});
U.use([St, Et]);
function Ps(s) {
    ...
    function u(n, l) {
        ...
        if (v.cache && e.virtual.cache[l]) return e.virtual.cache[l];
        let y;
        return (
            v.renderSlide
                ? ((y = v.renderSlide.call(e, n, l)),
                  typeof y == "string" && (ie(d, y), (y = d.children[0])))
                : e.isElement
                ? (y = Z("swiper-slide"))
                : (y = Z("div", e.params.slideClass)),
            y.setAttribute("data-swiper-slide-index", l),
            v.renderSlide || ie(y, n),
            v.cache && (e.virtual.cache[l] = y),
            y
        );
    }
    function o(n, l, v) {
        ...
        if (l && !b && E > 0) return;
        const { addSlidesBefore: O, addSlidesAfter: z } = e.params.virtual,
            { from: A, to: M, slides: T, slidesGrid: L, offset: P } = e.virtual;
        e.params.cssMode || e.updateActiveIndex();
        const C = typeof v > "u" ? e.activeIndex || 0 : v;
        let I;
        e.rtlTranslate
            ? (I = "right")
            : (I = e.isHorizontal() ? "left" : "top");
        let D, G;
        p
            ? ((D = Math.floor(y / 2) + h + z), (G = Math.floor(y / 2) + h + O))
            : ((D = y + (h - 1) + z), (G = (b ? y : h) + O));
        let S = C - G,
            x = C + D;
        b || ((S = Math.max(S, 0)), (x = Math.min(x, T.length - 1)));
        let B = (e.slidesGrid[S] || 0) - (e.slidesGrid[0] || 0);
        b && C >= G
            ? ((S -= G), p || (B += e.slidesGrid[0]))
            : b && C < G && ((S = -G), p && (B += e.slidesGrid[0])),
        ...
        if (A === S && M === x && !n) {
            e.slidesGrid !== L &&
                B !== P &&
                e.slides.forEach(($) => {
                    $.style[I] = `${B - Math.abs(e.cssOverflowAdjustment())}px`;
                }),
                e.updateProgress(),
                a("virtualUpdate");
            return;
        ...
        if (e.params.virtual.renderExternal) {
            e.params.virtual.renderExternal.call(e, {
                ...
                slides: (function () {
                    const H = [];
                    for (let R = S; R <= x; R += 1) H.push(T[R]);
                    return H;
                })(),
            }),
        ...
        if (n)
            e.slides
                .filter(($) =>
                    $.matches(`.${e.params.slideClass}, swiper-slide`)
                )
                .forEach(($) => {
                    $.remove();
                });
        ...
        const ve = b ? -T.length : 0,
            k = b ? T.length * 2 : T.length;
        for (let $ = ve; $ < k; $ += 1)
            if ($ >= S && $ <= x) {
                const H = ee($);
                typeof M > "u" || n
                    ? F.push(H)
                    : ($ > M && F.push(H), $ < A && N.push(H));
            }
        if (
            (F.forEach(($) => {
                e.slidesEl.append(u(T[$], $));
            }),
            b)
        )
            for (let $ = N.length - 1; $ >= 0; $ -= 1) {
                const H = N[$];
                e.slidesEl.prepend(u(T[H], H));
            }
        else
            N.sort(($, H) => H - $),
                N.forEach(($) => {
                    e.slidesEl.prepend(u(T[$], $));
                });
        _(e.slidesEl, ".swiper-slide, swiper-slide").forEach(($) => {
            $.style[I] = `${B - Math.abs(e.cssOverflowAdjustment())}px`;
        }),
            X();
    }
    ...
    function m(n) {
        ...
        if (e.params.virtual.cache) {
            ...
            Object.keys(h).forEach((b) => {
                const E = h[b],
                    O = E.getAttribute("data-swiper-slide-index");
                O &&
                    E.setAttribute(
    ...
    i("beforeInit", () => {
        ...
        if (typeof e.passedParams.virtual.slides > "u") {
            const l = [...e.slidesEl.children].filter((v) =>
            ...
            l &&
                ...
                (n = !0),
                l.forEach((v, y) => {
                    v.setAttribute("data-swiper-slide-index", y),
                        (e.virtual.cache[y] = v),
                        v.remove();
                }));
        }
        ...
        i("init update resize", () => {
            e.params.virtual.enabled &&
                e.params.cssMode &&
                Se(e.wrapperEl, "--swiper-virtual-size", `${e.virtualSize}px`);
        }),
        Object.assign(e.virtual, {
            appendSlide: f,
            prependSlide: m,
...
function Ls(s) {
    ...
    function d(f) {
        ...
        if (
            (!e.allowSlideNext &&
                ((e.isHorizontal() && h) || (e.isVertical() && b) || v)) ||
            (!e.allowSlidePrev &&
                ((e.isHorizontal() && y) || (e.isVertical() && p) || l))
        )
            return !1;
        if (
            ...
            e.isHorizontal()
                ? ((l || v || y || h) &&
                      (w.preventDefault
                          ? w.preventDefault()
                          : (w.returnValue = !1)),
                  (((v || h) && !m) || ((l || y) && m)) && e.slideNext(),
                  (((l || y) && !m) || ((v || h) && m)) && e.slidePrev())
                : ((l || v || p || b) &&
                      (w.preventDefault
                          ? w.preventDefault()
                          : (w.returnValue = !1)),
    ...
    function u() {
        e.keyboard.enabled ||
            (r.addEventListener("keydown", d), (e.keyboard.enabled = !0));
    }
    function o() {
        e.keyboard.enabled &&
            (r.removeEventListener("keydown", d), (e.keyboard.enabled = !1));
    }
    i("init", () => {
        ...
        Object.assign(e.keyboard, { enable: u, disable: o });
}
function Is(s) {
    let { swiper: e, extendParams: t, on: i, emit: a } = s;
    const r = V();
    ...
    function f(p) {
        ...
        return (
            ...
            "wheelDeltaX" in p && (z = -p.wheelDeltaX / 120),
            "axis" in p && p.axis === p.HORIZONTAL_AXIS && ((z = A), (A = 0)),
            (M = z * 10),
            (T = A * 10),
            "deltaY" in p && (T = p.deltaY),
            "deltaX" in p && (M = p.deltaX),
            p.shiftKey && !M && ((M = T), (T = 0)),
            (M || T) &&
                p.deltaMode &&
                (p.deltaMode === 1
                    ? ((M *= 40), (T *= 40))
            ...
            M && !z && (z = M < 1 ? -1 : 1),
            T && !A && (A = T < 1 ? -1 : 1),
            { spinX: z, spinY: A, pixelX: M, pixelY: T }
        );
    }
    function m() {
    ...
    function l(p) {
        ...
        if (M === 0) return !0;
        O.invert && (M = -M);
        let P = e.getTranslate() + M * O.sensitivity;
        if (
            ...
            if (!I) {
                ...
                if (
                    ...
                    const x = o.length ? o[o.length - 1] : void 0,
                        B = o[0];
                    if (
                        (o.push(C),
                        x && (C.delta > x.delta || C.direction !== x.direction))
                    )
                        o.splice(0);
                    else if (
                        o.length >= 15 &&
                    ...
                    c ||
                        (c = me(() => {
                            ...
                            (u = C),
                                o.splice(0),
                                e.slideToClosest(e.params.speed, !0, void 0, X);
                        }, 500));
                }
                if (
                    (I || a("scroll", b),
...
function zs(s) {
    ...
    function r(n) {
        ...
        return n &&
            typeof n == "string" &&
            e.isElement &&
            ((l = e.el.querySelector(n) || e.hostEl.querySelector(n)), l)
            ? l
            : (n &&
                  (typeof n == "string" &&
    ...
    function c(n, l) {
        ...
        (n = Y(n)),
            n.forEach((y) => {
                y &&
                    (y.classList[l ? "add" : "remove"](
                        ...v.disabledClass.split(" ")
                    ),
                    y.tagName === "BUTTON" && (y.disabled = l),
                    e.params.watchOverflow &&
                        e.enabled &&
                        y.classList[e.isLocked ? "add" : "remove"](
                            v.lockClass
                        ));
            });
    }
    function d() {
        ...
        c(l, e.isBeginning && !e.params.rewind),
            c(n, e.isEnd && !e.params.rewind);
    }
    function u(n) {
        n.preventDefault(),
    ...
    function f() {
        ...
        let l = r(n.nextEl),
            v = r(n.prevEl);
        Object.assign(e.navigation, { nextEl: l, prevEl: v }),
            (l = Y(l)),
            (v = Y(v));
        const y = (h, p) => {
            h && h.addEventListener("click", p === "next" ? o : u),
                !e.enabled && h && h.classList.add(...n.lockClass.split(" "));
        };
    ...
    function m() {
        ...
        (n = Y(n)), (l = Y(l));
        const v = (y, h) => {
            y.removeEventListener("click", h === "next" ? o : u),
                y.classList.remove(
    ...
    i("init", () => {
        ...
        i("click", (n, l) => {
            ...
            if (e.isElement && !p) {
                ...
                b && (p = b.find((E) => v.includes(E) || y.includes(E)));
            }
            if (e.params.navigation.hideOnClick && !p) {
                ...
                let b;
                v.length
                    ? (b = v[0].classList.contains(
                          e.params.navigation.hiddenClass
                      ))
                    : y.length &&
                      (b = y[0].classList.contains(
                          e.params.navigation.hiddenClass
                      )),
...
function As(s) {
    ...
    function m(h) {
        const p = h.target.closest(se(e.params.pagination.bulletClass));
        if (!p) return;
        h.preventDefault();
        const b = xe(p) * e.params.slidesPerGroup;
        if (e.params.loop) {
            if (e.realIndex === b) return;
            const E = f(e.realIndex, b, e.slides.length);
            E === "next"
                ? e.slideNext()
                : E === "previous"
                ? e.slidePrev()
    ...
    function w() {
        ...
        if (
            (e.params.loop
                ...
                ? ((E = e.snapIndex), (O = e.previousSnapIndex))
                : ((O = e.previousIndex || 0), (E = e.activeIndex || 0)),
            p.type === "bullets" &&
            ...
            if (
                (p.dynamicBullets &&
                    ((c = _e(M[0], e.isHorizontal() ? "width" : "height")),
                    b.forEach((C) => {
                    ...
                    p.dynamicMainBullets > 1 &&
                        O !== void 0 &&
                        ((d += E - (O || 0)),
                        d > p.dynamicMainBullets - 1
                            ? (d = p.dynamicMainBullets - 1)
                            : d < 0 && (d = 0)),
                    (T = Math.max(E - d, 0)),
                    (L = T + (Math.min(M.length, p.dynamicMainBullets) - 1)),
                    (P = (L + T) / 2)),
                M.forEach((C) => {
                    const I = [
                        ...[
            ...
            if (p.dynamicBullets) {
                const C = Math.min(M.length, p.dynamicMainBullets + 4),
                    I = (c * C - c) / 2 - P * c,
                    D = h ? "right" : "left";
                M.forEach((G) => {
                    G.style[e.isHorizontal() ? D : "top"] = `${I}px`;
                });
            }
        }
        b.forEach((M, T) => {
            if (
                (p.type === "fraction" &&
                    (M.querySelectorAll(se(p.currentClass)).forEach((L) => {
                        L.textContent = p.formatFractionCurrent(E + 1);
                    }),
                    M.querySelectorAll(se(p.totalClass)).forEach((L) => {
                        L.textContent = p.formatFractionTotal(A);
                    })),
                p.type === "progressbar")
            ) {
                let L;
                ...
                let C = 1,
                    I = 1;
                L === "horizontal" ? (C = P) : (I = P),
                    M.querySelectorAll(se(p.progressbarFillClass)).forEach(
                        (D) => {
                            (D.style.transform = `translate3d(0,0,0) scaleX(${C}) scaleY(${I})`),
                                (D.style.transitionDuration = `${e.params.speed}ms`);
                        }
                    );
            }
            p.type === "custom" && p.renderCustom
                ? (ie(M, p.renderCustom(e, E + 1, A)),
                  T === 0 && a("paginationRender", M))
                : (T === 0 && a("paginationRender", M),
                  a("paginationUpdate", M)),
                e.params.watchOverflow &&
                    e.enabled &&
    ...
    function g() {
        ...
        if (h.type === "bullets") {
            ...
            for (let z = 0; z < O; z += 1)
                h.renderBullet
                    ? (E += h.renderBullet.call(e, z, h.bulletClass))
                    : (E += `<${h.bulletElement} ${
        ...
        h.type === "fraction" &&
            ...
            (e.pagination.bullets = []),
            b.forEach((O) => {
                h.type !== "custom" && ie(O, E || ""),
                    h.type === "bullets" &&
                        e.pagination.bullets.push(
                            ...O.querySelectorAll(se(h.bulletClass))
                        );
            }),
            ...
            !(!p || p.length === 0) &&
                ...
                p.forEach((b) => {
                    h.type === "bullets" &&
                        ...
                        h.clickable && b.addEventListener("click", m),
        ...
        i("click", (h, p) => {
            ...
            if (
                ...
                if (
                    ...
                    return;
                const O = E[0].classList.contains(
                    e.params.pagination.hiddenClass
                );
                a(O === !0 ? "paginationShow" : "paginationHide"),
                    E.forEach((z) =>
...
function Os(s) {
    ...
    function g() {
        ...
        const { scrollbar: P, rtlTranslate: C } = e,
            { dragEl: I, el: D } = P,
        ...
        C
            ? ((B = -B),
              B > 0 ? ((x = f - B), (B = 0)) : -B + f > m && (x = m + B))
            : B < 0
            ? ((x = f + B), (B = 0))
            : B + f > m && (x = m - B),
            e.isHorizontal()
                ? ((I.style.transform = `translate3d(${B}px, 0, 0)`),
                  (I.style.width = `${x}px`))
                : ((I.style.transform = `translate3d(0px, ${B}px, 0)`),
                  (I.style.height = `${x}px`)),
            G.hide &&
                (clearTimeout(d),
                (D.style.opacity = 1),
                (d = setTimeout(() => {
                    (D.style.opacity = 0),
                        (D.style.transitionDuration = "400ms");
                }, 1e3)));
    }
    function n(P) {
    ...
    function l() {
        ...
        (C.style.width = ""),
            (C.style.height = ""),
            (m = e.isHorizontal() ? I.offsetWidth : I.offsetHeight),
            (w =
                e.size /
                (e.virtualSize +
            ...
            e.isHorizontal()
                ? (C.style.width = `${f}px`)
                : (C.style.height = `${f}px`),
            w >= 1 ? (I.style.display = "none") : (I.style.display = ""),
    ...
    function y(P) {
        const { scrollbar: C, rtlTranslate: I } = e,
            { el: D } = C;
        let G;
        (G =
            (v(P) -
                ze(D)[e.isHorizontal() ? "left" : "top"] -
                (o !== null ? o : f / 2)) /
            (m - f)),
    ...
    function h(P) {
        ...
        (c = !0),
            ...
            C.hide && (G.style.opacity = 1),
            e.params.cssMode &&
                (e.wrapperEl.style["scroll-snap-type"] = "none"),
            a("scrollbarDragStart", P);
    }
    function p(P) {
        const { scrollbar: C, wrapperEl: I } = e,
            { el: D, dragEl: G } = C;
        c &&
    ...
    function b(P) {
        ...
        c &&
            ...
            a("scrollbarDragEnd", P),
            C.snapOnRelease && e.slideToClosest());
    }
    function E(P) {
        const { scrollbar: C, params: I } = e,
            D = C.el;
        if (!D) return;
        const G = D,
            S = I.passiveListeners ? { passive: !1, capture: !1 } : !1,
            x = I.passiveListeners ? { passive: !0, capture: !1 } : !1;
        if (!G) return;
    ...
    function A() {
        const { scrollbar: P, el: C } = e;
        e.params.scrollbar = Ue(
            e,
        ...
        if (
            (typeof I.el == "string" &&
                e.isElement &&
                (D = e.el.querySelector(I.el)),
            !D && typeof I.el == "string")
        ) {
        ...
        let G;
        D &&
            ((G = D.querySelector(se(e.params.scrollbar.dragClass))),
            G || ((G = Z("div", e.params.scrollbar.dragClass)), D.append(G))),
            Object.assign(P, { el: D, dragEl: G }),
            I.draggable && O(),
            D &&
                D.classList[e.enabled ? "remove" : "add"](
                    ...le(e.params.scrollbar.lockClass)
                );
    }
    function M() {
    ...
    i("changeDirection", () => {
        ...
        (C = Y(C)),
            C.forEach((I) => {
                I.classList.remove(P.horizontalClass, P.verticalClass),
                    I.classList.add(
        ...
        i("init", () => {
            e.params.scrollbar.enabled === !1 ? L() : (A(), l(), g());
        }),
    ...
    const T = () => {
            e.el.classList.remove(
                ...le(e.params.scrollbar.scrollbarDisabledClass)
            ),
                e.scrollbar.el &&
...
function $s(s) {
    ...
    const a =
        ...
        r = (u, o) => {
            const { rtl: f } = e,
                m = f ? -1 : 1,
                w = u.getAttribute("data-swiper-parallax") || "0";
            let g = u.getAttribute("data-swiper-parallax-x"),
                n = u.getAttribute("data-swiper-parallax-y");
            const l = u.getAttribute("data-swiper-parallax-scale"),
                v = u.getAttribute("data-swiper-parallax-opacity"),
        ...
        c = () => {
            const {
                ...
                g = _(u, a);
            e.isElement && g.push(..._(e.hostEl, a)),
                g.forEach((n) => {
                    r(n, f);
                }),
                o.forEach((n, l) => {
        ...
        d = function (u) {
            ...
            const { el: o, hostEl: f } = e,
                m = [...o.querySelectorAll(a)];
            e.isElement && m.push(...f.querySelectorAll(a)),
                m.forEach((w) => {
                    let g =
                        parseInt(
                            w.getAttribute("data-swiper-parallax-duration"),
                            10
                        ) || u;
...
function Ds(s) {
    ...
    function h() {
        ...
        const k = g[0].pageX,
            ...
            H = g[1].pageX,
            R = g[1].pageY;
        return Math.sqrt((H - k) ** 2 + (R - $) ** 2);
    }
    function p() {
        const k = e.params.zoom,
            $ = n.imageWrapEl.getAttribute("data-swiper-zoom") || k.maxRatio;
        if (k.limitToOriginalSize && n.imageEl && n.imageEl.naturalWidth) {
            const H = n.imageEl.naturalWidth / n.imageEl.offsetWidth;
            return Math.min(H, $);
        }
        return $;
    }
    function b() {
        ...
        return [
            (g[0].pageX + (g[1].pageX - g[0].pageX) / 2 - k.x - r.scrollX) / c,
            (g[0].pageY + (g[1].pageY - g[0].pageY) / 2 - k.y - r.scrollY) / c,
        ];
    }
    function E() {
    ...
    function O(k) {
        ...
        return !!(
            k.target.matches($) ||
            e.slides.filter((H) => H.contains(k.target)).length > 0
        );
    }
    function z(k) {
        ...
        return !!(
            k.target.matches($) ||
            [...e.hostEl.querySelectorAll($)].filter((H) =>
                H.contains(k.target)
            ).length > 0
        );
    }
    function A(k) {
        if ((k.pointerType === "mouse" && g.splice(0, g.length), !O(k))) return;
        const $ = e.params.zoom;
        if (((m = !1), (w = !1), g.push(k), !(g.length < 2))) {
            if (((m = !0), (n.scaleStart = h()), !n.slideEl)) {
                (n.slideEl = k.target.closest(
                    `.${e.params.slideClass}, swiper-slide`
                )),
                    n.slideEl || (n.slideEl = e.slides[e.activeIndex]);
                let H = n.slideEl.querySelector(`.${$.containerClass}`);
                if (
                    (H &&
    ...
    function M(k) {
        ...
        const $ = e.params.zoom,
            H = e.zoom,
            R = g.findIndex((q) => q.pointerId === k.pointerId);
        R >= 0 && (g[R] = k),
            !(g.length < 2) &&
                ((w = !0),
                (n.scaleMove = h()),
                n.imageEl &&
                    ...
                    H.scale > n.maxRatio &&
                        (H.scale =
                            n.maxRatio - 1 + (H.scale - n.maxRatio + 1) ** 0.5),
                    H.scale < $.minRatio &&
                        (H.scale =
                            $.minRatio + 1 - ($.minRatio - H.scale + 1) ** 0.5),
                    (n.imageEl.style.transform = `translate3d(0,0,0) scale(${H.scale})`)));
    }
    function T(k) {
        if (!O(k) || (k.pointerType === "mouse" && k.type === "pointerout"))
            return;
        const $ = e.params.zoom,
            H = e.zoom,
            R = g.findIndex((q) => q.pointerId === k.pointerId);
        R >= 0 && g.splice(R, 1),
            !(!m || !w) &&
                ...
                n.imageEl &&
                    ...
                    (d = !1),
                    H.scale > 1 && n.slideEl
                        ? n.slideEl.classList.add(`${$.zoomedSlideClass}`)
                        : H.scale <= 1 &&
                          n.slideEl &&
                          n.slideEl.classList.remove(`${$.zoomedSlideClass}`),
                    H.scale === 1 &&
                        ((n.originX = 0),
                        (n.originY = 0),
                        (n.slideEl = void 0))));
    ...
    function I(k) {
        ...
        $.android && k.cancelable && k.preventDefault(), (l.isTouched = !0);
        const H = g.length > 0 ? g[0] : k;
        (l.touchesStart.x = H.pageX), (l.touchesStart.y = H.pageY);
    }
    function D(k) {
        const H = k.pointerType === "mouse" && e.params.zoom.panOnMouseMove;
        if (!O(k) || !z(k)) return;
        const R = e.zoom;
        if (!n.imageEl) return;
        ...
        l.isMoved ||
            ((l.width = n.imageEl.offsetWidth || n.imageEl.clientWidth),
            (l.height = n.imageEl.offsetHeight || n.imageEl.clientHeight),
            (l.startX = We(n.imageWrapEl, "x") || 0),
            (l.startY = We(n.imageWrapEl, "y") || 0),
            (n.slideWidth = n.slideEl.offsetWidth),
            (n.slideHeight = n.slideEl.offsetHeight),
            (n.imageWrapEl.style.transitionDuration = "0ms"));
        const q = l.width * R.scale,
            re = l.height * R.scale;
        if (
            ((l.minX = Math.min(n.slideWidth / 2 - q / 2, 0)),
            (l.maxX = -l.minX),
            (l.minY = Math.min(n.slideHeight / 2 - re / 2, 0)),
            (l.maxY = -l.minY),
            (l.touchesCurrent.x = g.length > 0 ? g[0].pageX : k.pageX),
            (l.touchesCurrent.y = g.length > 0 ? g[0].pageY : k.pageY),
            Math.max(
        ...
        k.cancelable && k.preventDefault(),
            ...
            C(),
            (l.isMoved = !0);
        const te = (R.scale - c) / (n.maxRatio - e.params.zoom.minRatio),
            { originX: ne, originY: j } = n;
        (l.currentX =
            l.touchesCurrent.x -
            l.touchesStart.x +
            l.startX +
            ...
            v.prevPositionX || (v.prevPositionX = l.touchesCurrent.x),
            v.prevPositionY || (v.prevPositionY = l.touchesCurrent.y),
            v.prevTime || (v.prevTime = Date.now()),
            (v.x =
                (l.touchesCurrent.x - v.prevPositionX) /
                (Date.now() - v.prevTime) /
                2),
            (v.y =
                (l.touchesCurrent.y - v.prevPositionY) /
                (Date.now() - v.prevTime) /
                2),
            Math.abs(l.touchesCurrent.x - v.prevPositionX) < 2 && (v.x = 0),
            Math.abs(l.touchesCurrent.y - v.prevPositionY) < 2 && (v.y = 0),
            (v.prevPositionX = l.touchesCurrent.x),
            (v.prevPositionY = l.touchesCurrent.y),
            (v.prevTime = Date.now()),
            (n.imageWrapEl.style.transform = `translate3d(${l.currentX}px, ${l.currentY}px,0)`);
    }
    function G() {
        const k = e.zoom;
        ...
        const R = v.x * $,
            ...
            re = v.y * H,
            ae = l.currentY + re;
        v.x !== 0 && ($ = Math.abs((q - l.currentX) / v.x)),
            v.y !== 0 && (H = Math.abs((ae - l.currentY) / v.y));
        const te = Math.max($, H);
        (l.currentX = q), (l.currentY = ae);
        const ne = l.width * k.scale,
            j = l.height * k.scale;
        (l.minX = Math.min(n.slideWidth / 2 - ne / 2, 0)),
            (l.maxX = -l.minX),
            (l.minY = Math.min(n.slideHeight / 2 - j / 2, 0)),
            (l.maxY = -l.minY),
            (l.currentX = Math.max(Math.min(l.currentX, l.maxX), l.minX)),
            (l.currentY = Math.max(Math.min(l.currentY, l.maxY), l.minY)),
            (n.imageWrapEl.style.transitionDuration = `${te}ms`),
            (n.imageWrapEl.style.transform = `translate3d(${l.currentX}px, ${l.currentY}px,0)`);
    }
    function S() {
        const k = e.zoom;
    ...
    function x(k) {
        if (c <= 1 || !n.imageWrapEl || !O(k) || !z(k)) return;
        const $ = r.getComputedStyle(n.imageWrapEl).transform,
            H = new r.DOMMatrix($);
        if (!u) {
            (u = !0),
                (o.x = k.clientX),
        ...
        const R = (k.clientX - o.x) * f,
            q = (k.clientY - o.y) * f,
            re = l.width * c,
            ae = l.height * c,
            te = n.slideWidth,
            ne = n.slideHeight,
            j = Math.min(te / 2 - re / 2, 0),
            J = -j,
            we = Math.min(ne / 2 - ae / 2, 0),
            Me = -we,
            fe = Math.max(Math.min(l.startX + R, J), j),
            ue = Math.max(Math.min(l.startY + q, Me), we);
        (n.imageWrapEl.style.transitionDuration = "0ms"),
            (n.imageWrapEl.style.transform = `translate3d(${fe}px, ${ue}px, 0)`),
            (o.x = k.clientX),
            (o.y = k.clientY),
            (l.startX = fe),
            (l.startY = ue),
    ...
    function B(k) {
        ...
        if (!n.slideEl) {
            ...
            let ye = n.slideEl.querySelector(`.${H.containerClass}`);
            ye &&
                (ye = ye.querySelectorAll(
                    "picture, img, svg, canvas, .swiper-zoom-target"
                )[0]),
                (n.imageEl = ye),
                ye
                    ? (n.imageWrapEl = de(n.imageEl, `.${H.containerClass}`)[0])
                    : (n.imageWrapEl = void 0);
        }
        ...
        let R, q, re, ae, te, ne, j, J, we, Me, fe, ue, Ce, Pe, $e, De, ke, Ge;
        typeof l.touchesStart.x > "u" && k
            ? ((R = k.pageX), (q = k.pageY))
            : ((R = l.touchesStart.x), (q = l.touchesStart.y));
        const He = c,
            pe = typeof k == "number" ? k : null;
        c === 1 &&
            pe &&
            ((R = void 0),
            (q = void 0),
        ...
        ($.scale = pe || Ke),
            (c = pe || Ke),
            k && !(c === 1 && pe)
                ? ((ke = n.slideEl.offsetWidth),
                  (Ge = n.slideEl.offsetHeight),
                  (re = ze(n.slideEl).left + r.scrollX),
                  (ae = ze(n.slideEl).top + r.scrollY),
                  (te = re + ke / 2 - R),
                  (ne = ae + Ge / 2 - q),
                  (we = n.imageEl.offsetWidth || n.imageEl.clientWidth),
                  (Me = n.imageEl.offsetHeight || n.imageEl.clientHeight),
                  (fe = we * $.scale),
                  (ue = Me * $.scale),
                  (Ce = Math.min(ke / 2 - fe / 2, 0)),
                  (Pe = Math.min(Ge / 2 - ue / 2, 0)),
                  ($e = -Ce),
                  (De = -Pe),
                  He > 0 &&
                  pe &&
                  ...
                  typeof l.currentY == "number"
                      ? ((j = (l.currentX * $.scale) / He),
                        (J = (l.currentY * $.scale) / He))
                      : ((j = te * $.scale), (J = ne * $.scale)),
                  j < Ce && (j = Ce),
                  j > $e && (j = $e),
                  J < Pe && (J = Pe),
                  J > De && (J = De))
                : ((j = 0), (J = 0)),
            pe && $.scale === 1 && ((n.originX = 0), (n.originY = 0)),
            (l.currentX = j),
            (l.currentY = J),
            (n.imageWrapEl.style.transitionDuration = "300ms"),
            (n.imageWrapEl.style.transform = `translate3d(${j}px, ${J}px,0)`),
            (n.imageEl.style.transitionDuration = "300ms"),
            (n.imageEl.style.transform = `translate3d(0,0,0) scale(${$.scale})`);
    }
    function X() {
        const k = e.zoom,
            $ = e.params.zoom;
        if (!n.slideEl) {
            ...
            H &&
                ...
                (n.imageEl = H),
                H
                    ? (n.imageWrapEl = de(n.imageEl, `.${$.containerClass}`)[0])
                    : (n.imageWrapEl = void 0);
        }
        !n.imageEl ||
            !n.imageWrapEl ||
    ...
    function F() {
        const k = e.params.passiveListeners ? { passive: !0, capture: !1 } : !1,
            $ = e.params.passiveListeners ? { passive: !1, capture: !0 } : !0;
        return { passiveListener: k, activeListenerWithCapture: $ };
    }
    function ee() {
        const k = e.zoom;
        if (k.enabled) return;
        k.enabled = !0;
        const { passiveListener: $, activeListenerWithCapture: H } = F();
        e.wrapperEl.addEventListener("pointerdown", A, $),
            e.wrapperEl.addEventListener("pointermove", M, H),
            ["pointerup", "pointercancel", "pointerout"].forEach((R) => {
                e.wrapperEl.addEventListener(R, T, $);
            }),
            e.wrapperEl.addEventListener("pointermove", D, H);
    }
    function ve() {
        const k = e.zoom;
        if (!k.enabled) return;
        k.enabled = !1;
        const { passiveListener: $, activeListenerWithCapture: H } = F();
        e.wrapperEl.removeEventListener("pointerdown", A, $),
            e.wrapperEl.removeEventListener("pointermove", M, H),
            ["pointerup", "pointercancel", "pointerout"].forEach((R) => {
                e.wrapperEl.removeEventListener(R, T, $);
            }),
            e.wrapperEl.removeEventListener("pointermove", D, H);
    }
    i("init", () => {
...
function ks(s) {
    ...
    function r(o) {
        e.controller.spline = e.params.loop
            ? new a(e.slidesGrid, o.slidesGrid)
            : new a(e.snapGrid, o.snapGrid);
    }
    function c(o, f) {
        ...
        function l(v) {
            ...
            e.params.controller.by === "slide" &&
                (r(v), (g = -e.controller.spline.interpolate(-y))),
                (!g || e.params.controller.by === "container") &&
                    ((w =
                        (v.maxTranslate() - v.minTranslate()) /
                        (e.maxTranslate() - e.minTranslate())),
                    (Number.isNaN(w) || !Number.isFinite(w)) && (w = 1),
                    (g = (y - e.minTranslate()) * w + v.minTranslate())),
                e.params.controller.inverse && (g = v.maxTranslate() - g),
                v.updateProgress(g),
                v.setTranslate(g, e),
                v.updateActiveIndex(),
    ...
    i("beforeInit", () => {
        ...
        i("setTranslate", (o, f, m) => {
            !e.controller.control ||
                ...
                e.controller.setTranslate(f, m);
        }),
        i("setTransition", (o, f, m) => {
            !e.controller.control ||
                e.controller.control.destroyed ||
                e.controller.setTransition(f, m);
        }),
...
function Gs(s) {
    ...
    function o(S) {
        ...
        return "x".repeat(S).replace(/x/g, x);
    }
    function f(S) {
        (S = Y(S)),
            S.forEach((x) => {
    ...
    function w(S, x) {
        (S = Y(S)),
            S.forEach((B) => {
                B.setAttribute("role", x);
            });
    }
    function g(S, x) {
        (S = Y(S)),
            S.forEach((B) => {
                B.setAttribute("aria-roledescription", x);
            });
    }
    function n(S, x) {
        (S = Y(S)),
            S.forEach((B) => {
                B.setAttribute("aria-controls", x);
            });
    }
    function l(S, x) {
        (S = Y(S)),
    ...
    function b(S) {
        ...
        if (
            !(
                e.pagination &&
                e.pagination.el &&
                (B === e.pagination.el || e.pagination.el.contains(S.target)) &&
                !S.target.matches(se(e.params.pagination.bulletClass))
            )
        ) {
            if (e.navigation && e.navigation.prevEl && e.navigation.nextEl) {
                const X = Y(e.navigation.prevEl);
                Y(e.navigation.nextEl).includes(B) &&
                    ((e.isEnd && !e.params.loop) || e.slideNext(),
                    e.isEnd ? u(x.lastSlideMessage) : u(x.nextSlideMessage)),
                    X.includes(B) &&
                        ((e.isBeginning && !e.params.loop) || e.slidePrev(),
                        e.isBeginning
                            ? u(x.firstSlideMessage)
                            : u(x.prevSlideMessage));
            }
            e.pagination &&
                B.matches(se(e.params.pagination.bulletClass)) &&
                B.click();
        }
    }
    function E() {
        if (e.params.loop || e.params.rewind || !e.navigation) return;
        const { nextEl: S, prevEl: x } = e.navigation;
        x && (e.isBeginning ? (h(x), m(x)) : (p(x), f(x))),
            S && (e.isEnd ? (h(S), m(S)) : (p(S), f(S)));
    }
    function O() {
        return (
        ...
        O() &&
            e.pagination.bullets.forEach((x) => {
                e.params.pagination.clickable &&
                    ...
                    x.matches(se(e.params.pagination.bulletActiveClass))
    ...
    const M = (S, x, B) => {
            f(S),
                S.tagName !== "BUTTON" &&
                    (w(S, "button"), S.addEventListener("keydown", b)),
                l(S, B),
                n(S, x);
        },
        T = (S) => {
            c && c !== S.target && !c.contains(S.target) && (r = !0),
                (e.a11y.clicked = !0);
        },
        L = () => {
            (r = !1),
        ...
        C = (S) => {
            if (
                ...
                new Date().getTime() - d < 100
            )
                return;
            const x = S.target.closest(`.${e.params.slideClass}, swiper-slide`);
            if (!x || !e.slides.includes(x)) return;
            c = x;
            const B = e.slides.indexOf(x) === e.activeIndex,
                X =
                ...
                requestAnimationFrame(() => {
                    r ||
                        (e.params.loop
                            ...
                            : e.slideTo(
                                  e.getSlideIndexWhenGrid(e.slides.indexOf(x)),
                                  0
                              ),
                        (r = !1));
                }));
        ...
        I = () => {
            ...
            S.itemRoleDescriptionMessage &&
                g(e.slides, S.itemRoleDescriptionMessage),
                S.slideRole && w(e.slides, S.slideRole);
            const x = e.slides.length;
            S.slideLabelMessage &&
                e.slides.forEach((B, X) => {
                    const N = e.params.loop
                            ? parseInt(
                                  B.getAttribute("data-swiper-slide-index"),
                                  10
                              )
                            : X,
                        F = S.slideLabelMessage
                            .replace(/\{\{index\}\}/, N + 1)
        ...
        D = () => {
            ...
            S.containerRoleDescriptionMessage &&
                g(x, S.containerRoleDescriptionMessage),
                S.containerMessage && l(x, S.containerMessage),
                S.containerRole && w(x, S.containerRole);
            const B = e.wrapperEl,
                X = S.id || B.getAttribute("id") || `swiper-wrapper-${o(16)}`,
                N =
                    e.params.autoplay && e.params.autoplay.enabled
                        ? "off"
                        : "polite";
            v(B, X), y(B, N), I();
            let { nextEl: F, prevEl: ee } = e.navigation ? e.navigation : {};
            (F = Y(F)),
                (ee = Y(ee)),
                F && F.forEach((k) => M(k, X, S.nextSlideMessage)),
                ee && ee.forEach((k) => M(k, X, S.prevSlideMessage)),
                z() &&
                    Y(e.pagination.el).forEach(($) => {
    ...
    function G() {
        a && a.remove();
        let { nextEl: S, prevEl: x } = e.navigation ? e.navigation : {};
        (S = Y(S)),
            (x = Y(x)),
            S && S.forEach((X) => X.removeEventListener("keydown", b)),
            x && x.forEach((X) => X.removeEventListener("keydown", b)),
            z() &&
                Y(e.pagination.el).forEach((N) => {
    ...
    i("beforeInit", () => {
        (a = Z("span", e.params.a11y.notificationClass)),
...
function Hs(s) {
    ...
    const c = (g) =>
        ...
        u = (g, n) => {
            ...
            (p && p.value === h) ||
                (e.params.history.replaceState
                    ? l.history.replaceState({ value: h }, null, h)
                    : l.history.pushState({ value: h }, null, h));
        },
        o = (g, n, l) => {
            if (n)
        ...
        m = () => {
            ...
            if (e.params.history) {
                ...
                if (((a = !0), (r = d(e.params.url)), !r.key && !r.value)) {
                    e.params.history.replaceState ||
                        g.addEventListener("popstate", f);
                    return;
                }
                o(0, r.value, e.params.runCallbacksOnInit),
                    e.params.history.replaceState ||
                        g.addEventListener("popstate", f);
            }
        },
        w = () => {
            const g = V();
            e.params.history.replaceState ||
                g.removeEventListener("popstate", f);
        };
    i("init", () => {
        ...
        hashNavigation: {
            ...
            getSlideIndex(w, g) {
                if (e.virtual && e.params.virtual.enabled) {
                    const n = e.slides.find(
                        (v) => v.getAttribute("data-hash") === g
                    );
                    return n
                        ? parseInt(
        ...
        o = () => {
            ...
            const w =
                    e.virtual && e.params.virtual.enabled
                        ...
                        : e.slides[e.activeIndex],
                g = w
                    ? w.getAttribute("data-hash") ||
                      w.getAttribute("data-history")
                    : "";
            e.params.hashNavigation.replaceState &&
            d.history &&
            d.history.replaceState
                ? (d.history.replaceState(null, null, `#${g}` || ""),
                  i("hashSet"))
                : ((c.location.hash = g || ""), i("hashSet"));
        },
        f = () => {
            if (
            ...
            e.params.hashNavigation.watchState &&
                d.addEventListener("hashchange", u);
        },
        m = () => {
            e.params.hashNavigation.watchState &&
                d.removeEventListener("hashchange", u);
        };
    a("init", () => {
...
function Xs(s) {
    ...
    function p(x) {
        !e ||
            e.destroyed ||
            !e.wrapperEl ||
            (x.target === e.wrapperEl &&
                (e.wrapperEl.removeEventListener("transitionend", p),
                !(h || (x.detail && x.detail.bySwiperTouchMove)) && T()));
    }
    const b = () => {
            if (e.destroyed || !e.autoplay.running) return;
            e.autoplay.paused ? (w = !0) : w && ((o = f), (w = !1));
            const x = e.autoplay.paused ? f : m + o - new Date().getTime();
            (e.autoplay.timeLeft = x),
                a("autoplayTimeLeft", x, x / u),
        ...
        E = () => {
            ...
            return (
                e.virtual && e.params.virtual.enabled
                    ...
                    : (x = e.slides[e.activeIndex]),
                x
                    ? parseInt(x.getAttribute("data-swiper-autoplay"), 10)
                    : void 0
            );
        },
        O = (x) => {
            ...
            let B = typeof x > "u" ? e.params.autoplay.delay : x;
        ...
        M = (x, B) => {
            ...
            (f = (f || e.params.autoplay.delay) - (new Date().getTime() - m)),
        ...
        L = () => {
            if (e.destroyed || !e.autoplay.running) return;
            const x = W();
            x.visibilityState === "hidden" && ((y = !0), M(!0)),
                x.visibilityState === "visible" && T();
        },
        P = (x) => {
            x.pointerType === "mouse" &&
                ((y = !0),
        ...
        C = (x) => {
            x.pointerType === "mouse" && ((h = !1), e.autoplay.paused && T());
        },
        I = () => {
        ...
        G = () => {
            W().addEventListener("visibilitychange", L);
        },
        S = () => {
            W().removeEventListener("visibilitychange", L);
        };
    i("init", () => {
        e.params.autoplay.enabled && (I(), G(), z());
    }),
        i("destroy", () => {
            D(), S(), e.autoplay.running && A();
        }),
        ...
        Object.assign(e.autoplay, { start: z, stop: A, pause: M, resume: T });
}
function Ys(s) {
    let { swiper: e, extendParams: t, on: i } = s;
    t({
    ...
    function c() {
        ...
        const f = o.clickedIndex,
            m = o.clickedSlide;
        if (
            (m &&
                m.classList.contains(e.params.thumbs.slideThumbActiveClass)) ||
            typeof f > "u" ||
            f === null
        )
            return;
        ...
        o.params.loop
            ? (w = parseInt(
                  o.clickedSlide.getAttribute("data-swiper-slide-index"),
                  10
              ))
            : (w = f),
    ...
    function d() {
        ...
        if (o.swiper instanceof f) {
            if (o.swiper.destroyed) return (a = !1), !1;
    ...
    function u(o) {
        ...
        const m =
            f.params.slidesPerView === "auto"
                ? f.slidesPerViewDynamic()
        ...
        if (
            ...
            (w = Math.floor(w)),
            f.slides.forEach((v) => v.classList.remove(g)),
            ...
            for (let v = 0; v < w; v += 1)
                f.slides[e.realIndex + v] &&
                    f.slides[e.realIndex + v].classList.add(g);
    ...
    i("beforeInit", () => {
        ...
        if (!(!o || !o.swiper))
            if (
                typeof o.swiper == "string" ||
                o.swiper instanceof HTMLElement
            ) {
                const f = W(),
                    m = () => {
                        const g =
                            typeof o.swiper == "string"
                                ? f.querySelector(o.swiper)
                                : o.swiper;
                        if (g && g.swiper) (o.swiper = g.swiper), d(), u(!0);
                        else if (g) {
                            const n = `${e.params.eventsPrefix}init`,
                                l = (v) => {
                                    (o.swiper = v.detail[0]),
                                        g.removeEventListener(n, l),
                                        d(),
                                        u(!0),
                                        o.swiper.update(),
                                        e.update();
        ...
        Object.assign(e.thumbs, { init: d, update: u });
}
function Rs(s) {
    ...
    function c() {
        if (e.params.cssMode) return;
        const { touchEventsData: u, touches: o } = e;
    ...
    function d(u) {
        ...
        const {
            ...
            v = Q() - n.touchStartTime;
        if (o < -e.minTranslate()) {
            e.slideTo(e.activeIndex);
            return;
        }
        if (o > -e.maxTranslate()) {
            e.slides.length < g.length
        ...
        if (f.freeMode.momentum) {
            if (n.velocities.length > 1) {
                const A = n.velocities.pop(),
                    M = n.velocities.pop(),
                    T = A.position - M.position,
                    L = A.time - M.time;
                (e.velocity = T / L),
                    (e.velocity /= 2),
                    Math.abs(e.velocity) < f.freeMode.minimumVelocity &&
                        (e.velocity = 0),
                    (L > 150 || Q() - A.time > 300) && (e.velocity = 0);
            } else e.velocity = 0;
            (e.velocity *= f.freeMode.momentumVelocityRatio),
            ...
            if (p < e.maxTranslate())
                f.freeMode.momentumBounce
                    ? (p + e.maxTranslate() < -O && (p = e.maxTranslate() - O),
                      (E = e.maxTranslate()),
                      (b = !0),
                      (n.allowMomentumBounce = !0))
                    : (p = e.maxTranslate()),
                    f.loop && f.centeredSlides && (z = !0);
            else if (p > e.minTranslate())
                f.freeMode.momentumBounce
                    ? (p - e.minTranslate() > O && (p = e.minTranslate() + O),
                      (E = e.minTranslate()),
                      (b = !0),
                      (n.allowMomentumBounce = !0))
                    : (p = e.minTranslate()),
                ...
                Math.abs(g[A] - p) < Math.abs(g[A - 1] - p) ||
                e.swipeDirection === "next"
                    ? (p = g[A])
                    : (p = g[A - 1]),
                    (p = -p);
            ...
            if (
                ...
                if (
                    ...
                    const A = Math.abs((w ? -p : p) - e.translate),
        ...
        (!f.freeMode.momentum || v >= f.longSwipesMs) &&
            (i("_freeModeStaticRelease"),
            e.updateProgress(),
            e.updateActiveIndex(),
            e.updateSlidesClasses());
    ...
    Object.assign(e, {
        freeMode: { onTouchStart: r, onTouchMove: c, onTouchEnd: d },
    });
}
function Vs(s) {
    let { swiper: e, extendParams: t, on: i } = s;
    ...
    const u = () => {
        ...
        m = (l, v, y) => {
            ...
            let z, A, M;
            if (E === "row" && h > 1) {
                const T = Math.floor(l / (h * b)),
                    L = l - b * h * T,
                    P =
                        T === 0
                            ? h
                            : Math.min(Math.ceil((O - T * b * h) / b), h);
                (M = Math.floor(L / P)),
                    (A = L - M * P + T * h),
                    (z = A + (M * a) / b),
                    (v.style.order = z);
                ...
                E === "column"
                    ? ((A = Math.floor(l / b)),
                      ...
                      (A > c || (A === c && M === b - 1)) &&
                          ((M += 1), M >= b && ((M = 0), (A += 1))))
                    : ((M = Math.floor(l / r)), (A = l - M * r));
            (v.row = M),
                (v.column = A),
                (v.style.height = `calc((100% - ${(b - 1) * p}px) / ${b})`),
        ...
        w = (l, v) => {
            ...
            if (
                ...
                for (let O = 0; O < v.length; O += 1) {
                    let z = v[O];
                    h && (z = Math.floor(z)),
                        v[O] < e.virtualSize + v[0] && E.push(z);
                }
        ...
        n = () => {
            const { params: l, el: v } = e,
                y = l.grid && l.grid.rows > 1;
            d && !y
                ? (v.classList.remove(
                ...
                : !d &&
                  y &&
                  (v.classList.add(`${l.containerModifierClass}grid`),
                  l.grid.fill === "column" &&
                      v.classList.add(`${l.containerModifierClass}grid-column`),
                  e.emitContainerClasses()),
                (d = y);
        };
    i("init", g),
...
function Ns(s) {
    ...
    const a = (r) => {
        if (typeof r == "string") {
            ...
            ie(c, r), i.append(c.children[0]), ie(c, "");
        } else i.append(r);
    };
...
function Fs(s) {
    ...
    const c = (d) => {
        if (typeof d == "string") {
            ...
            ie(u, d), a.prepend(u.children[0]), ie(u, "");
        } else a.prepend(d);
    };
    if (typeof s == "object" && "length" in s) {
        for (let d = 0; d < s.length; d += 1) s[d] && c(s[d]);
        r = i + s.length;
    } else c(s);
    e.recalcSlides(),
        t.loop && e.loopCreate(),
...
function Ws(s, e) {
    ...
    if (typeof e == "object" && "length" in e) {
        for (let f = 0; f < e.length; f += 1) e[f] && r.append(e[f]);
        u = c > s ? c + e.length : c;
    } else r.append(e);
    for (let f = 0; f < o.length; f += 1) r.append(o[f]);
    t.recalcSlides(),
        i.loop && t.loopCreate(),
...
function js(s) {
    ...
    Object.assign(e, {
        ...
        prependSlide: Fs.bind(e),
        addSlide: Ws.bind(e),
        removeSlide: _s.bind(e),
...
function Oe(s) {
    ...
    const { activeIndex: r } = e,
        c = (d) =>
            d.parentElement
                ? d.parentElement
                : e.slides.find(
                      (o) => o.shadowRoot && o.shadowRoot === d.parentNode
                  );
    if (e.params.virtualTranslate && t !== 0) {
        ...
        a
            ? (u = i)
            : (u = i.filter((o) => {
                  const f = o.classList.contains("swiper-slide-transform")
                      ? c(o)
                      : o;
            ...
            setTranslate: () => {
                ...
                for (let u = 0; u < c.length; u += 1) {
                    ...
                    const g = e.params.fadeEffect.crossFade
                        ...
                        n = Te(d, o);
                    (n.style.opacity = g),
                        (n.style.transform = `translate3d(${m}px, ${w}px, 0px)`);
                }
            },
            setTransition: (c) => {
    ...
    const a = (u, o, f) => {
        ...
        m ||
            ...
            w ||
                ...
                u.append(w)),
            m && (m.style.opacity = Math.max(-o, 0)),
            w && (w.style.opacity = Math.max(o, 0));
    };
    ge({
        effect: "cube",
        swiper: e,
        ...
        setTranslate: () => {
            ...
            y.shadow &&
                (h
                    ? ((E = e.wrapperEl.querySelector(".swiper-cube-shadow")),
                      E ||
                          ((E = Z("div", "swiper-cube-shadow")),
                          e.wrapperEl.append(E)),
                      (E.style.height = `${m}px`))
                    : ((E = u.querySelector(".swiper-cube-shadow")),
                      E ||
                          ((E = Z("div", "swiper-cube-shadow")), u.append(E))));
            for (let z = 0; z < f.length; z += 1) {
                ...
                M % 4 === 0
                    ...
                    : (M - 2) % 4 === 0
                    ? ((C = n + L * 4 * n), (D = n))
                    : (M - 3) % 4 === 0 && ((C = -n), (D = 3 * n + n * 4 * L)),
                    g && (C = -C),
                    h || ((I = C), (C = 0));
                const G = `rotateX(${v(h ? 0 : -T)}deg) rotateY(${v(
                    h ? T : 0
                )}deg) translate3d(${C}px, ${I}px, ${D}px)`;
                P <= 1 &&
                    P > -1 &&
                    ((b = M * 90 + P * 90), g && (b = -M * 90 - P * 90)),
                    (A.style.transform = G),
                    y.slideShadows && a(A, P, h);
            }
            if (
                ((o.style.transformOrigin = `50% 50% -${n / 2}px`),
                (o.style["-webkit-transform-origin"] = `50% 50% -${n / 2}px`),
                y.shadow)
            )
                if (h)
                    E.style.transform = `translate3d(0px, ${
                        m / 2 + y.shadowOffset
                    }px, ${-m / 2}px) rotateX(89.99deg) rotateZ(0deg) scale(${
                        y.shadowScale
                    })`;
                else {
                    const z = Math.abs(b) - Math.floor(Math.abs(b) / 90) * 90,
                        A =
                            1.5 -
                        ...
                        T = y.shadowScale / A,
                        L = y.shadowOffset;
                    E.style.transform = `scale3d(${M}, 1, ${T}) translate3d(0px, ${
                        w / 2 + L
                    }px, ${-w / 2 / T}px) rotateX(-89.99deg)`;
                }
            const O =
                (l.isSafari || l.isWebView) && l.needPerspectiveFix
                    ? -n / 2
                    : 0;
            (o.style.transform = `translate3d(0px,0,${O}px) rotateX(${v(
                e.isHorizontal() ? 0 : b
            )}deg) rotateY(${v(e.isHorizontal() ? -b : 0)}deg)`),
                o.style.setProperty("--swiper-cube-translate-z", `${O}px`);
        },
        setTransition: (u) => {
            const { el: o, slides: f } = e;
            if (
                (f.forEach((m) => {
...
function he(s, e, t) {
    ...
    return r || ((r = Z("div", i.split(" "))), a.append(r)), r;
}
function Zs(s) {
    let { swiper: e, extendParams: t, on: i } = s;
    ...
    const a = (u, o) => {
        let f = e.isHorizontal()
            ...
            m = e.isHorizontal()
                ? u.querySelector(".swiper-slide-shadow-right")
                : u.querySelector(".swiper-slide-shadow-bottom");
        f || (f = he("flip", u, e.isHorizontal() ? "left" : "top")),
            m || (m = he("flip", u, e.isHorizontal() ? "right" : "bottom")),
            f && (f.style.opacity = Math.max(-o, 0)),
            m && (m.style.opacity = Math.max(o, 0));
    };
    ge({
        effect: "flip",
        ...
        on: i,
        setTranslate: () => {
            const { slides: u, rtlTranslate: o } = e,
                f = e.params.flipEffect,
                m = Ae(e);
            for (let w = 0; w < u.length; w += 1) {
                const g = u[w];
                let n = g.progress;
                e.params.flipEffect.limitRotation &&
                    (n = Math.max(Math.min(g.progress, 1), -1));
                ...
                e.isHorizontal()
                    ? o && (y = -y)
                    : ((b = p), (p = 0), (h = -y), (y = 0)),
                    (g.style.zIndex = -Math.abs(Math.round(n)) + u.length),
                    f.slideShadows && a(g, n);
                const E = `translate3d(${p}px, ${b}px, 0px) rotateX(${m(
                        h
                    )}deg) rotateY(${m(y)}deg)`,
                    O = Te(f, g);
                O.style.transform = E;
        ...
        setTransition: (u) => {
            ...
            o.forEach((f) => {
                (f.style.transitionDuration = `${u}ms`),
                    f
                        .querySelectorAll(
                            ".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left"
                        )
                ...
                Oe({ swiper: e, duration: u, transformElements: o });
        },
        recreateShadows: () => {
            e.params.flipEffect,
                e.slides.forEach((u) => {
                    let o = u.progress;
                    e.params.flipEffect.limitRotation &&
                        (o = Math.max(Math.min(u.progress, 1), -1)),
                        a(u, o);
                });
        },
        ...
        ge({
            ...
            setTranslate: () => {
                ...
                for (let y = 0, h = u.length; y < h; y += 1) {
                    ...
                    typeof L == "string" &&
                        L.indexOf("%") !== -1 &&
                        (L = (parseFloat(f.stretch) / 100) * b);
                    let P = m ? 0 : L * z,
                        C = m ? L * z : 0,
                        I = 1 - (1 - f.scale) * Math.abs(z);
                    ...
                    const D = `translate3d(${C}px,${P}px,${T}px)  rotateX(${v(
                            M
                        )}deg) rotateY(${v(A)}deg) scale(${I})`,
                        G = Te(f, p);
                    if (
                        ((G.style.transform = D),
                        (p.style.zIndex = -Math.abs(Math.round(z)) + 1),
                        f.slideShadows)
                    ) {
                        let S = m
                        ...
                        S || (S = he("coverflow", p, m ? "left" : "top")),
                            ...
                            S && (S.style.opacity = z > 0 ? z : 0),
                            x && (x.style.opacity = -z > 0 ? -z : 0);
                    }
                }
            },
            setTransition: (c) => {
...
function Js(s) {
    ...
    ge({
        ...
        on: i,
        setTranslate: () => {
            const { slides: d, wrapperEl: u, slidesSizesGrid: o } = e,
                f = e.params.creativeEffect,
                { progressMultiplier: m } = f,
            ...
            for (let n = 0; n < d.length; n += 1) {
                const l = d[n],
                    v = l.progress,
                    y = Math.min(
                        Math.max(l.progress, -f.limitProgress),
                        f.limitProgress
                    );
                let h = y;
                w ||
                    (h = Math.min(
                        Math.max(l.originalProgress, -f.limitProgress),
                        f.limitProgress
                    ));
                const p = l.swiperSlideOffset,
                ...
                y < 0
                    ...
                    E.forEach((I, D) => {
                        let G = z.rotate[D] * Math.abs(y * m);
                        E[D] = G;
                    }),
                    (l.style.zIndex = -Math.abs(Math.round(v)) + d.length);
                const A = b.join(", "),
                    M = `rotateX(${g(E[0])}deg) rotateY(${g(
                        E[1]
                    )}deg) rotateZ(${g(E[2])}deg)`,
                    T =
                        h < 0
                            ? `scale(${1 + (1 - z.scale) * h * m})`
                            : `scale(${1 - (1 - z.scale) * h * m})`,
                    L =
                        h < 0
                            ? 1 + (1 - z.opacity) * h * m
                ...
                if ((O && z.shadow) || !O) {
                    ...
                    if ((!I && z.shadow && (I = he("creative", l)), I)) {
                        const D = f.shadowPerProgress
                            ? y * (1 / f.limitProgress)
                            : y;
                ...
                (C.style.transform = P),
                    (C.style.opacity = L),
                    z.origin && (C.style.transformOrigin = z.origin);
            }
        },
        setTransition: (d) => {
...
function ei(s) {
    ...
    t({
        ...
        ge({
            ...
            on: i,
            setTranslate: () => {
                const { slides: c, activeIndex: d, rtlTranslate: u } = e,
                    o = e.params.cardsEffect,
                    { startTranslate: f, isTouched: m } = e.touchEventsData,
                    w = u ? -e.translate : e.translate;
                for (let g = 0; g < c.length; g += 1) {
                    const n = c[g],
                        l = n.progress,
                        v = Math.min(Math.max(l, -4), 4);
                    ...
                    let E = 1,
                        O = -o.perSlideRotate * v,
                        z = o.perSlideOffset - Math.abs(v) * 0.75;
                    const A =
                            e.virtual && e.params.virtual.enabled
                                ? e.virtual.from + g
                                : g,
                    ...
                    if (M || T) {
                        const I =
                            (1 - Math.abs((Math.abs(v) - 0.5) / 0.5)) ** 0.5;
                        (O += -28 * v * I),
                            (E += -0.5 * I),
                            (z += 96 * I),
                            (p = `${-25 * I * Math.abs(v)}%`);
      ...
      `;
            ...
            setTransition: (c) => {
                ...
                d.forEach((u) => {
                    ...
                    Oe({ swiper: e, duration: c, transformElements: d });
            },
            perspective: () => !0,
            overwriteParams: () => ({
                _loopSwapReset: !1,
